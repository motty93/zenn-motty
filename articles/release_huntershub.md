...
Claude CodeとCursor、ChatGPTを併用して開発しています。
...
UIの使いづらさやバグ、欲しい機能などがあれば、GitHubのIssueやTwitterで教えてもらえると嬉しいです。


### コミュニティの拡大

モンハンポータブルシリーズをまだ遊んでいる人は意外と多いと思うので、そういう人たちが集まれる場所にしていきたいです。
Discordサーバーも作ろうかなと考えています。
